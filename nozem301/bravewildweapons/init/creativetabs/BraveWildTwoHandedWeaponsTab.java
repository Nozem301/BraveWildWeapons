...
public class BraveWildTwoHandedWeaponsTab extends CreativeTabs {
	
	public BraveWildTwoHandedWeaponsTab(String label) {
		super(Reference.MOD_ID + "." + label);
	}
	
	@Override
	public ItemStack getTabIconItem() {
		return new ItemStack(ModItems.TRAVELER_CLAYMORE);
	}
