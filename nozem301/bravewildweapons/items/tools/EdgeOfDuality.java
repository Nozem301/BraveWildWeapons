...
public class EdgeOfDuality extends ToolSword {
	
	public EdgeOfDuality(String name, ToolMaterial material) {
		super(name, material);
    ...
    public void addInformation(ItemStack stack, World worldIn, List<String> tooltip, ITooltipFlag flagIn)
    {
        ...
        {
            tooltip.add("A curious double-edged sword crafted using Sheikah technology.");
        }
        else
        {
