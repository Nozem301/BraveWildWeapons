...
public class EightfoldLongblade extends ToolSword {
	
	public EightfoldLongblade(String name, ToolMaterial material) {
		super(name, material);
    ...
    public void addInformation(ItemStack stack, World worldIn, List<String> tooltip, ITooltipFlag flagIn)
    {
        ...
        {
            tooltip.add("A single-edged sword seldom seen. This weapon is passed down through the Sheikah tribe and has an astonishingly sharp edge ideal for slicing.");
        }
        else
        {
