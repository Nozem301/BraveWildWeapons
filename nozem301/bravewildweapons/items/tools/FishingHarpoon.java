...
public class FishingHarpoon extends ToolSword {

	public FishingHarpoon(String name, ToolMaterial material) {
		super(name, material);
    ...
    public void addInformation(ItemStack stack, World worldIn, List<String> tooltip, ITooltipFlag flagIn)
    {
        ...
        {
            tooltip.add("A fisherman's tool with a sharp spearhead that makes it valuable as a weapon as well.");
        }
        else
        {
