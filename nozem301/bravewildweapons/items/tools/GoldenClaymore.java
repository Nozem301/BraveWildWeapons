...
public class GoldenClaymore extends ToolSword {
	
	public GoldenClaymore(String name, ToolMaterial material) {
		super(name, material);
    ...
    public void addInformation(ItemStack stack, World worldIn, List<String> tooltip, ITooltipFlag flagIn)
    {
        ...
        {
            tooltip.add("Only the most talented Gerudo sword fighters carry this two-handed sword.");
        }
        else
        {
