...
public class KnightsHalberd extends ToolSword {

	public KnightsHalberd(String name, ToolMaterial material) {
		super(name, material);
    ...
    public void addInformation(ItemStack stack, World worldIn, List<String> tooltip, ITooltipFlag flagIn)
    {
        ...
        {
            tooltip.add("A spear used by knights adept in mounted combat. The spearhead is modeled after an axe.");
        }
        else
        {
