...
public class RoyalClaymore extends ToolSword {

	public RoyalClaymore(String name, ToolMaterial material) {
		super(name, material);
    ...
    public void addInformation(ItemStack stack, World worldIn, List<String> tooltip, ITooltipFlag flagIn)
    {
        ...
        {
            tooltip.add("A two-handed sword issued to the royal family's immediate guard detail. Its powerful strikes are said to crush an opponent's body and resolve alike.");
        }
        else
        {
