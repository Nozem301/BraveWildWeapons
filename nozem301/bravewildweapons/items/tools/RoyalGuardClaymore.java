...
public class RoyalGuardClaymore extends ToolSword {

	public RoyalGuardClaymore(String name, ToolMaterial material) {
		super(name, material);
    ...
    public void addInformation(ItemStack stack, World worldIn, List<String> tooltip, ITooltipFlag flagIn)
    {
        ...
        {
            tooltip.add("The Sheikah used the very essence of ancient technology to forge this greatsword.");
        }
        else
        {
