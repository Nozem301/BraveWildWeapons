...
public class RoyalGuardSpear extends ToolSword {

	public RoyalGuardSpear(String name, ToolMaterial material) {
		super(name, material);
    ...
    public void addInformation(ItemStack stack, World worldIn, List<String> tooltip, ITooltipFlag flagIn)
    {
        ...
        {
            tooltip.add("This Sheikah-made spear was created using ancient technology to combat the Calamity.");
        }
        else
        {
