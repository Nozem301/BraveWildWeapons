...
public class RoyalHalberd extends ToolSword {

	public RoyalHalberd(String name, ToolMaterial material) {
		super(name, material);
    ...
    public void addInformation(ItemStack stack, World worldIn, List<String> tooltip, ITooltipFlag flagIn)
    {
        ...
        {
            tooltip.add("This spear was issued to the knights who guarded Hyrule Castle's throne room.");
        }
        else
        {
