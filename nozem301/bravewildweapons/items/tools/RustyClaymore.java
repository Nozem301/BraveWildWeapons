...
public class RustyClaymore extends ToolSword {

	public RustyClaymore(String name, ToolMaterial material) {
		super(name, material);
    ...
    public void addInformation(ItemStack stack, World worldIn, List<String> tooltip, ITooltipFlag flagIn)
    {
        ...
        {
            tooltip.add("A two-handed sword not properly cared for.");
        }
        else
        {
