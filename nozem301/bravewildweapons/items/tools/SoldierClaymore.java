...
public class SoldierClaymore extends ToolSword {

	public SoldierClaymore(String name, ToolMaterial material) {
		super(name, material);
    ...
    public void addInformation(ItemStack stack, World worldIn, List<String> tooltip, ITooltipFlag flagIn)
    {
        ...
        {
            tooltip.add("A two-handed sword designed for combat.");
        }
        else
        {
