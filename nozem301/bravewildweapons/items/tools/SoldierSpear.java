...
public class SoldierSpear extends ToolSword {

	public SoldierSpear(String name, ToolMaterial material) {
		super(name, material);
    ...
    public void addInformation(ItemStack stack, World worldIn, List<String> tooltip, ITooltipFlag flagIn)
    {
        ...
        {
            tooltip.add("A long spear once used by the guards of Hyrule Castle.");
        }
        else
        {
