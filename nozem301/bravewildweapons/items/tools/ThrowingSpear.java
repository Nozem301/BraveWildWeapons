...
public class ThrowingSpear extends ToolSword {
	
	public ThrowingSpear(String name, ToolMaterial material) {
		super(name, material);
    ...
    public void addInformation(ItemStack stack, World worldIn, List<String> tooltip, ITooltipFlag flagIn)
    {
        ...
        {
            tooltip.add("A specialized spear weighted to excel as a throwing weapon. ");
        }
        else
        {
