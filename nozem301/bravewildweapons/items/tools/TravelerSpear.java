...
public class TravelerSpear extends ToolSword {

	public TravelerSpear(String name, ToolMaterial material) {
		super(name, material);
    ...
    public void addInformation(ItemStack stack, World worldIn, List<String> tooltip, ITooltipFlag flagIn)
    {
        ...
        {
            tooltip.add("A spear used mainly by travelers to fend off wolves and other beasts.");
        }
        else
        {
